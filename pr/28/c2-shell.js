    ...
    const BUILD_VERSION = "pr28-445d0475";
    ...
    /*
     * Settings > General > Music. Changing it while the game runs switches
     * the soundtrack in place; otherwise it is passed at the next start.
     */
    musicSelect.value = localStorage.getItem(MUSIC_SOURCE) === "xmidi" ? "xmidi" : "recorded";
