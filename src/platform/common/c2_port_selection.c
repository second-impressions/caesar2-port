...
#define PORT_SELECTION_CLICK_SLOP 4
...
int c2_port_selection_consume_release(int mouse_x, int mouse_y)
{
    ...
    return dx >= -PORT_SELECTION_CLICK_SLOP && dx <= PORT_SELECTION_CLICK_SLOP &&
           dy >= -PORT_SELECTION_CLICK_SLOP && dy <= PORT_SELECTION_CLICK_SLOP;
}
#endif
